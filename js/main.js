...
(function($) {
    ...
    var kumarApp = { 
        ...
        initializ: function() {   
            kumarApp.preloader();
            kumarApp.stickyHeader();
            kumarApp.sectionScroll();
            kumarApp.smootScroll();           
            kumarApp.bg_parallax();       
            kumarApp.animated_progress();       
            kumarApp.testimonial();       
            kumarApp.fan_fact();     
            kumarApp.grid_masonry();     
            kumarApp.portfolio_isotop();     
            kumarApp.magnific_popup();        
            kumarApp.google_map();        
        }
    };
